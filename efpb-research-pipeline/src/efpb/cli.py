...
def run_config(config_path: str, output_root: str = "data/runs", only_controllers: Optional[Sequence[str]] = None, machine: int = 0, machines: int = 1) -> Dict[str, Any]:
    ...
    for scenario, controller, seed in jobs:
        ...
        results.append(run_one(cfg, scenario, controller, int(seed), output_root, manifest))
...
def main() -> None:
    ...
    print(json.dumps(run_config(args.config, args.output_root, args.controllers, args.machine, args.machines), indent=2))
